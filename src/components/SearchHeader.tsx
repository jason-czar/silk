...
const SearchHeader = ({
  ...
  // Common gradient background class that will be applied to both desktop and compact versions
  const gradientBgClass = "bg-gradient-to-b from-[#EBEBEB]/60 to-[#EBEBEB]/10 dark:from-gray-900/60 dark:to-gray-900/10 backdrop-blur-sm";
